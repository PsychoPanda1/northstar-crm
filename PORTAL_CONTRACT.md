...
- `POST /api/customers/:id/preferences` → owner/dispatcher-only update of tenant-scoped SMS/email opt-out flags; direct messages and reactivation campaigns reject or skip opted-out channels, while customer tokens never expose preference metadata
