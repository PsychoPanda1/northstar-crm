...
- `GET /api/customers/:id/timeline?limit=...` → return a bounded, tenant-scoped customer timeline projection of activities, messages, and job lifecycle records without requiring consumers to load the full profile payload
