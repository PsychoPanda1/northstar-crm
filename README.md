...
- Owners can configure those technician forms through a bounded visual builder for form names, field types, select options, required fields, and conditional visibility, with an advanced JSON editor retained for migrations
