...
- Recurring-plan billing can create an auditable provider-pending Card/ACH intent from the customer's default vaulted payment-method token when `autoPay` is enabled; settlement still requires the signed provider webhook
