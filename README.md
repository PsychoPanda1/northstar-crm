...
- Customer service-plan pause, cancellation, and change requests route through an owner-reviewed, idempotent, audited queue; fulfillment updates the plan and cancels future plan jobs when required
