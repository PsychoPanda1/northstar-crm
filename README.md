...
- Dispatch can batch-invoice up to 50 completed jobs with all-or-nothing validation, direct job links, optional per-job amounts, and idempotent replay protection
