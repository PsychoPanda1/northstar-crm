...
assert(invoice.includes('data-installment-id') && invoice.includes('selectedInstallmentId') && invoice.includes('installmentId:selectedInstallmentId') && invoice.includes("(selectedInstallmentId||'invoice')"), 'customer invoice payment page does not target scheduled installments safely');
...
assert(customer.includes('Payment plan installment number') && customer.includes('installmentId:installment.id'), 'customer portal payment action does not target scheduled installments');
