...
assert(server.includes('statusIdempotencyKey') && repository.includes('updateLeadStatus(id, status, note = \'\', idempotencyKey') && app.includes('data-lead-status'), 'lead status workflow is not wired');
