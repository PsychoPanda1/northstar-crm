...
assert(app.includes('data-global-search=') && app.includes('global-search-view') && app.includes("'Purchase orders': 'purchase-orders'"), 'global search results do not provide actionable record navigation');
