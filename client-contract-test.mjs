...
assert(repository.includes('async listUsers()') && repository.includes('async createUser(') && repository.includes('async updateUserStatus(') && server.includes("pathname === '/api/users'") && server.includes('runtimeAccountsFor') && server.includes('cannot_suspend_current_user'), 'runtime user access management is not wired through the tenant API');
...
assert(app.includes('userAccessButton') && app.includes('repository.createUser(') && app.includes('repository.updateUserStatus(') && app.includes("User access"), 'runtime user access management is not exposed in the owner workspace');
