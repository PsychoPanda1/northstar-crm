...
assert(server.includes('leadAssignmentMatch && req.method === \'POST\'') && repository.includes('assignLead') && app.includes('data-lead-assignment'), 'lead ownership workflow is not wired');
