...
assert(app.includes('data-request-action="reply"') && app.includes('replyToRequest') && app.includes('Reply queued by'), 'owner request queue does not expose customer reply workflow');
