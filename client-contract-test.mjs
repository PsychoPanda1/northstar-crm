...
assert(app.includes('const decorateInvoiceSchedules =') && app.includes('data-invoice-action="view-schedule"') && app.includes('repository.getPaymentSchedule') && app.includes('View installments'), 'owner invoice workflow does not expose payment schedule visibility');
