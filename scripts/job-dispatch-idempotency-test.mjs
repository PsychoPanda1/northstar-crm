...
try {
  writeFileSync(dataFile, JSON.stringify({ [tenantId]: { customers: [{ id: 'dispatch-customer', tenantId, name: 'Dispatch Customer', phone: '8435550188', location: '1 Route Way' }], teamMembers: [{ id: 'team-marcus', tenantId, name: 'Marcus Thompson', role: 'Field technician', skills: ['Plumbing'], status: 'Active' }, { id: 'team-jordan', tenantId, name: 'Jordan Lee', role: 'Field technician', skills: ['Plumbing'], status: 'Active' }, { id: 'team-alex', tenantId, name: 'Alex Rivera', role: 'Field technician', skills: ['Plumbing'], status: 'Active' }], jobs: [{ id: jobId, tenantId, customerId: 'dispatch-customer', customer: 'Dispatch Customer', service: 'Plumbing repair', technician: null, status: 'Unassigned', time: 'Tomorrow 9:00 AM' }, { id: crewJobId, tenantId, customerId: 'dispatch-customer', customer: 'Dispatch Customer', service: 'Crew plumbing repair', requiredSkill: 'Plumbing', technician: null, status: 'Unassigned', time: 'Tomorrow 11:00 AM' }], auditEvents: [], activities: [] } }));
