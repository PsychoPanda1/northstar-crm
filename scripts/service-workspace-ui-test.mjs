...
if (!app.includes('import-catalog-csv') || !app.includes('parseCsv') || !app.includes('repository.importCatalogItems(items)')) throw new Error('catalog workspace must expose practical CSV pricebook import');
