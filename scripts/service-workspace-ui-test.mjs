...
if (!app.includes('import-catalog-csv') || !app.includes('parseCsv') || !app.includes('repository.importCatalogItems(items)') || !app.includes('bulk-catalog-archive') || !app.includes('repository.bulkUpdateCatalogItems(ids, false)')) throw new Error('catalog workspace must expose practical CSV import and bulk archive controls');
