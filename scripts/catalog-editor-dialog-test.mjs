...
for (const snippet of ['catalog-editor-dialog.js', 'catalog-editor-dialog', 'form.elements.durationMinutes', 'form.reportValidity()', 'repository.updateCatalogItem', 'data-catalog-action="edit"', 'stopImmediatePropagation()', 'role="alert"']) {
