...
writeFileSync(dataFile, JSON.stringify({ [tenantId]: { customers: [{ id: 'customer-q2c-1', tenantId, name: estimate.customer, phone: '843-555-0188', location: '8 Quote Lane' }], estimates: [estimate], jobs: [{ id: 'job-q2c-1', tenantId, estimateId: estimate.id, customerId: estimate.customerId, customer: estimate.customer, service: estimate.service, status: 'Completed', location: '8 Quote Lane' }] } }));
