...
const env = { ...process.env, NODE_ENV: 'development', NORTHSTAR_ALLOW_DEMO_LOGIN: 'true', NORTHSTAR_LEAD_PROVIDER_URL: `http://127.0.0.1:${providerPort}/leads`, NORTHSTAR_LEAD_PROVIDER_API_KEY: 'lead-test-key', NORTHSTAR_TENANT_PROVIDER_CONFIG_JSON: JSON.stringify({ 'clearwater-plumbing': { lead: { url: `http://127.0.0.1:${providerPort}/tenant-leads`, apiKey: 'tenant-lead-key' } } }), NORTHSTAR_LEAD_RETRY_LIMIT: '1', PORT: String(port), NORTHSTAR_DATA_FILE: dataFile, NORTHSTAR_SESSION_FILE: `${dataFile}.sessions` };
