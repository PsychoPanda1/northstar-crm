...
if (!serviceWorker.includes("'/integration-recovery-owner.js'") || !serviceWorker.includes('northstar-shell-v17')) throw new Error('integration recovery asset must remain installable offline');
