...
for (const snippet of ["id = 'job-access-link-dialog'", 'data-job-action="link"', 'data-job-action="customer-link"', 'technicianLink', 'customerLink', 'clipboard.writeText', 'readonly', 'expiry', 'stopImmediatePropagation()']) {
