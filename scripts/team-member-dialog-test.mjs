...
assert(source.includes('#add-team-member') && source.includes('#add-team') && source.includes('createTeamMember') && source.includes('crypto.randomUUID'), 'team member dialog does not target the owner shell trigger or use the idempotent team API');
