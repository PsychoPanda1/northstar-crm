...
for (const snippet of ['id = \'customer-payment-method-dialog\'', 'providerPaymentMethodId', 'data-action="add-payment-method"', 'data-action="remove-payment-method"', 'stopImmediatePropagation()', 'card or bank details']) {
