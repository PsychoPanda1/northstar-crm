...
assert(source.includes('#dispatch-route-optimize') && source.includes('data-route-optimize-all') && source.includes('data-route-optimize'), 'route optimization triggers are incomplete');
