...
try {
  writeFileSync(dataFile, JSON.stringify({ [tenantId]: { customers: [{ id: 'plan-status-customer', tenantId, name: 'Plan Status Customer', phone: '8435550101', location: '1 Plan Way' }], plans: [{ id: planId, tenantId, customerId: 'plan-status-customer', customer: 'Plan Status Customer', service: 'Annual plumbing care', amount: 120, value: '$120.00 / month', status: 'Active', renewal: 'Monthly', recurringSeriesId: 'series-test', nextVisit: { time: '2099-01-03 09:00 AM', startsAt: '2099-01-03T14:00:00.000Z', endsAt: '2099-01-03T15:00:00.000Z' } }], jobs: [{ id: 'plan-status-job', tenantId, planId, customerId: 'plan-status-customer', customer: 'Plan Status Customer', service: 'Annual plumbing care', status: 'Confirmed', time: '2099-01-03 09:00 AM', startsAt: '2099-01-03T14:00:00.000Z', endsAt: '2099-01-03T15:00:00.000Z' }], auditEvents: [], activities: [] } }));
