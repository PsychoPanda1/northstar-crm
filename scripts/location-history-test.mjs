...
try {
  writeFileSync(dataFile, JSON.stringify({ [tenantId]: { customers: [{ id: 'location-customer', tenantId, name: 'Location Customer', phone: '843-555-0199', location: '1 Tracking Way' }], materials: [{ id: 'location-material', tenantId, name: 'Tracking valve', sku: 'TRACK-SKU', barcode: 'TRACK-BARCODE', unit: 'each', unitCost: 5, onHand: 4 }], assets: [{ id: 'asset-location', tenantId, customerId: 'location-customer', name: 'Water heater', serial: 'WH-123', installed: '2020', status: 'Active' }], jobs: [{ id: 'JOB-LOCATION-1', tenantId, customerId: 'location-customer', customer: 'Location Customer', service: 'Plumbing', technician: 'Alex Rivera', status: 'En route', priority: 'High', time: 'Today 9:00 AM', location: '1 Tracking Way' }, { id: 'JOB-LOCATION-0', tenantId, customerId: 'location-customer', customer: 'Location Customer', service: 'Water heater repair', technician: 'Jordan Lee', status: 'Completed', time: 'Yesterday', location: '1 Tracking Way', updatedAt: '2026-09-05T12:00:00.000Z', findings: [{ title: 'Aging shutoff', note: 'Valve is stiff', severity: 'High', recommendation: 'Inspect before next visit' }] }] } }));
