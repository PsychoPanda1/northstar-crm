...
if (!serviceWorker.includes("'/analytics-history-owner.js'") || !serviceWorker.includes('northstar-shell-v15')) throw new Error('analytics history asset must remain installable offline');
