...
if (!serviceWorker.includes("'/analytics-history-owner.js'") || !serviceWorker.includes('northstar-shell-v10')) throw new Error('analytics history asset must remain installable offline');
