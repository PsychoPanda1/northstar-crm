...
if (!source.includes('requestWithTimeout') || !source.includes('AbortController') || !source.includes('timeoutMs ?? 20000')) throw new Error('landing client requests are not bounded');
