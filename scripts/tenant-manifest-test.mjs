...
try {
  ...
  const technicianEndpointKeys = ['job', 'fieldGuide', 'status', 'visitStatus', 'clock', 'customerContext', 'checklist', 'photo', 'finding', 'form', 'asset', 'labor', 'materials', 'estimate', 'paymentIntent', 'complete', 'location'];
