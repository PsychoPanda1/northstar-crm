...
const env = { ...process.env, NODE_ENV: 'development', NORTHSTAR_ALLOW_DEMO_LOGIN: 'true', NORTHSTAR_INVENTORY_PROVIDER_URL: `http://127.0.0.1:${providerPort}/inventory`, NORTHSTAR_INVENTORY_PROVIDER_API_KEY: 'inventory-test-key', NORTHSTAR_TENANT_PROVIDER_CONFIG_JSON: JSON.stringify({ 'clearwater-plumbing': { inventory: { url: `http://127.0.0.1:${providerPort}/tenant-inventory`, apiKey: 'tenant-inventory-key' } } }), NORTHSTAR_INVENTORY_RETRY_LIMIT: '1', PORT: String(port), NORTHSTAR_DATA_FILE: dataFile, NORTHSTAR_SESSION_FILE: `${dataFile}.sessions` };
