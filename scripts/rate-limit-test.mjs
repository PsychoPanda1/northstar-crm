...
const env = { ...process.env, NODE_ENV: 'development', PORT: String(port), NORTHSTAR_DATA_FILE: dataFile, NORTHSTAR_PUBLIC_LEAD_RATE_LIMIT: '2', NORTHSTAR_PUBLIC_MUTATION_RATE_LIMIT: '3', NORTHSTAR_TRUST_PROXY: 'true' };
