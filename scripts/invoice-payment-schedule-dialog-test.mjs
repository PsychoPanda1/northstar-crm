...
for (const snippet of ["id = 'invoice-payment-schedule-dialog'", 'data-invoice-action="schedule"', 'createPaymentSchedule', 'At booking', 'On completion', 'stopImmediatePropagation()', 'role="status"']) {
