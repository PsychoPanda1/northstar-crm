...
if (!serviceWorker.includes("'/payroll-operations-owner.js'") || !serviceWorker.includes("'/payroll-integration-owner.js'") || !serviceWorker.includes("'/next-actions.css'") || !serviceWorker.includes("northstar-shell-v7")) throw new Error('payroll operations assets must remain installable offline');
