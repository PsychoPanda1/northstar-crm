...
| Pricebook and estimates | Implemented | Tenant catalog, duration-aware capacity, itemized estimates, included-work option packages, revisions, send/approve/decline, conversion | Add production document delivery |
