...
| Scheduling and dispatch | Implemented | Day/week views, capacity, conflict checks, technician recommendations, route ordering, map handoff, reminders, rebooks | Add live map/vehicle telemetry and stronger optimization for large routes |
